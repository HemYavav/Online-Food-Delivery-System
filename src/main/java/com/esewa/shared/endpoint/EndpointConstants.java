package com.esewa.shared.endpoint;
...
public class EndpointConstants {
    ...
    public static final String RECREATED_DELETED_USER_BY_ID = "/recreate-deleted-user-by/{id}";
    public static final String API_RECIPE = "/api/recipe";
    public static final String API_CREATE_BY_USER_ID = "/created-by-user/{userId}";
